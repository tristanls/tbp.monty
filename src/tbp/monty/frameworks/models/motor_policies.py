...
class TouchObject(PositioningProcedure):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Since the PositioningProcedure is a state machine, set this flag to True, then
        we return the last action to take, and on the next invocation we return a
        PositioningProcedureResult with success=True, terminated=True.
        """
    ...
    def positioning_call(
        ...
        if depth_at_center > 0:
            # The object is not visible, there is nothing to touch.
            return PositioningProcedureResult(success=False, terminated=True)
        ...
        return PositioningProcedureResult(actions=[self.action])
